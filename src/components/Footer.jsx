...
function Footer() {
  return (
    <div className="bg-blue-300 w-[100%] h-52 px-10 mt-5 text-justify py-5">
      <article className="flex justify-center mt-5">
        <ul className="flex text-white ">
          <li className="hover:translate-y-[-10px] transition-all duration-[200ms]">
            <svg
	...
	V28.385z"
          ...
          <li className="hover:translate-y-[-10px] transition-all duration-[200ms] hover:shadow-[0_3px_10px_1px_rgba(0,0,0,0.3)]">
